 ...
 */
    ...
    $overall_traffic_username = $username_enc;
    $overall_traffic_type = $type;
    $overall_traffic_size = $size;
    ...
    // print HTML prologue
    $title = t('Intro','graphsoveralltraffic.php');
    $help = t('helpPage','graphsoveralltraffic');
    ...
    if (!empty($username)) {
        ...
        $src = sprintf("library/graphs/overall_users_data.php?category=traffic&type=%s&size=%s&user=%s", $type, $size, $username_enc);
        $alt = sprintf("total traffic of user %s", $username_enc);
        ...
        include('library/tables/overall_users_traffic.php');
        echo '</div>';
